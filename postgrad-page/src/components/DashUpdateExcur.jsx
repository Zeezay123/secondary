...
const DashUpdateExcur = () => {
  ...
  const fetchExcurData = async () => {
    try {
      const response = await fetch('/api/settings/excur', {
        method: 'GET',
        headers: {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await fetch(`/api/settings/updateexcur/${selectedExcurId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json'
        },
...
export default DashUpdateExcur;